      ...
      <div className="border-b border-white/5 pt-16 pb-12">
        <div className="container px-4 md:px-8">
          ...
          <p className="text-xs font-bold text-muted-foreground uppercase tracking-[0.2em]">
            Add funds to the Exodia smart contract
          </p>
        </div>
      </div>
            ...
            <section className="space-y-8">
              ...
              <div className="p-5 border border-white/5 bg-white/2 space-y-4">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Deposits are recognized immediately after one network
                  confirmation. Funds will be available for trading or transfer
                  instantly.
                </p>
              </div>
